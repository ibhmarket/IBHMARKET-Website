...
const WhyToChoose = () => {
  return (
    <div className="">
      <section className="py-6 md:my-24  bg-gradient-to-r from-[#F47C03] via-[#D9009C] to-[#717BF9]">
        <div className="py-8 px-4 mx-auto max-w-screen-2xl text-center lg:py-16 lg:px-12">
          <h1 className="mb-4 text-xl font-normal aspirefont leading-none  md:text-5xl lg:text-4xl text-white">
            {" "}
