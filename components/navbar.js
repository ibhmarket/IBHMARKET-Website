  ...
  return (
    <div>
      <nav className=" nav flex flex-wrap items-center justify-between lg:px-36 px-3">
        <div className="flex flex-no-shrink items-center mr-6 py-3 text-grey-darkest text-gray-400 hover:text-white ">
      ...
      <path d="M447.216 670.822l89.44-44.72v-89.45l-89.44-44.72v178.89zM447.216 402.492l89.44-44.721v-89.443l-89.44-44.722"></path>
          ...
          <Link
            href="#"
            className="font-semibold aspirefont tracking-[0.3em] text-xl text-white "
          >
            IBH
          </Link>
        </div>
        ...
        <li className="m-auto text-gray-400 hover:text-white ">
          ...
          <ul className="flex flex-row p-2 md:mt-2   md:flex-row md:space-x-4  md:text-lg md:font-medium   ">
            <li className="md:mr-0  hover:scale-110 transition duration-300 ease-in-out">
              <Link href="mailto:ibhmarket.com@gmail.com">
                <svg
                  fill="#ffffff  "
